...
public class QnaBoardSQL {
	...
	public final static String QNA_BOARD_REPLY_INSERT ="insert into qna_board "
																	...
																	+ "values(QNA_BOARD_QB_NO_SEQ.nextval, ?, ?,0,?,?,?,?)";
	// 게시글 수정 (완료)
	...
	// 답글 존재여부 확인 (미완) 
	public final static String QNA_BOARD_COUNTREPLY ="select count(*) cnt from qna_board where qb_groupno = ? and qb_depth >= ?  and qb_step >= ? order by qb_step,qb_depth asc";
