...
public class QnaBoardTestMain {
	...
	System.out.println(boardDao.insert(new QnaBoard(0, "Dao테스트으1", "Dao테스트으2", null, 0, 0, 1, 0, "customer2")));
	System.out.println(boardDao.insert(new QnaBoard(0, "Dao테스트으3", "Dao테스트으3", null, 0, 0, 1, 0, "customer3")));
	
	/*
	System.out.println("2.---------Delete 게시물------------");
	System.out.println(boardDao.delete(1));
	*/
	/*
