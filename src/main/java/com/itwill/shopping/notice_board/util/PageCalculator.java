package com.itwill.shopping.notice_board.util;
...
public class PageCalculator{	
	public static BoardListPageDto getPagingInfo(
		...
		boardListPageDto.setTotalPageCountCount(totalPageCount);
		...
		System.out.println("03.요청페이지번호\t\t:"+boardListPageDto.getSelectPageNo());
		System.out.println("04.전체게시물수\t\t\t:"+boardListPageDto.getTotalRecordCount());
		System.out.println("05.전체페이지수\t\t\t:"+boardListPageDto.getTotalPageCount());
		System.out.println("06.요청페이지그룹번호\t\t:"+groupNo);
		System.out.println("07.요청페이지그룹시작번호\t:"+boardListPageDto.getStartPageNo());
		System.out.println("08.요청페이지그룹끝번호\t\t:"+boardListPageDto.getEndPageNo());
		System.out.println("09.이전페이지그룹시작번호\t:"+boardListPageDto.getPreviousGroupStartPageNo());
		System.out.println("10.다음페이지그룹시작번호\t:"+boardListPageDto.getNextGroupStartPageNo());
		System.out.println("11.DB에서select할게시물시작번호 :"+boardListPageDto.getStartRowNum());
		System.out.println("12.DB에서select할게시물끝번호   :"+boardListPageDto.getEndRowNum());
		System.out.println("13.이전페이지그룹보여주기◀\t:"+boardListPageDto.isShowPreviousGroup());
		System.out.println("14.다음페이지그룹보여주기▶\t:"+boardListPageDto.isShowNextGroup()); 		
		System.out.println("15.처음페이지보여주기◀◀\t:"+boardListPageDto.isShowFirst());
		System.out.println("16.마지막페이지보여주기▶▶\t:"+boardListPageDto.isShowLast()); 		
		System.out.println("**************************************");
...
//	 페이지에 [처음으로] 아이콘 출력여부를 판단하는 메소드
	  ...
	  public static void main(String[] args) {
		  ...
		  */
		  ...
		  BoardListPageDto resultBean = PageCalculator.getPagingInfo(selectPage,rowCountPerPage,pageCountPerPage,totalRecordCount);
		  System.out.println("***************페이지정보***************");
