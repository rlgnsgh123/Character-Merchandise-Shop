...
// 리스트 페이지에서 출력에 필요한 테이블 데이터 및 페이징 처리에 필요한 정보클래스
public class BoardListPageDto {
	private List<NoticeBoard> list; 		// 리스트 데이터 콜렉션
	...
	private int startRowNum;        //게시물시작번호
	private int endRowNum;          //게시물끝번호
	...
	public BoardListPageDto(List<NoticeBoard> list, int startPageNo, int endPageNo,
