...
<div id =contetnt style="width:45%; margin: 0 auto">
	<form name="b" method="post">
		...
		<tr>
			...
			<input style="width: 150" type="text" name="title" value="RE:<%=board.getQb_title()%>"></td>
		</tr>
		<tr>
			<td width=300 align=center bgcolor="E6ECDE" height="22">내용</td>
			<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
			<textarea name="content" class="textarea" style="width: 535px" rows="20">[원글] <%=board.getQb_content().replace("\n","[원글] : ").trim()%></textarea>
			</td>
		</tr>
		</table>
	</form>
