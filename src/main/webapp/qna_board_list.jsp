   		...
   		<div class="container">
            ...
            <div class="row">
                ...
                <ul class="nav nav-tabs nav-product-tabs">
                    ...
                    <li><a href="#" data-toggle="tab">고객센터</a></li>
...
<div id="content"style="width:74%; margin: 0 auto">
	...
	bgcolor="BBBBBB">
		<tr>
			...
			%>
			<tr>
				<td width=100 align=center bgcolor="ffffff"><%=board.getQb_no() %></td>				
				...
				<td width=200 align=center bgcolor="ffffff"><%=board.getQb_date().toString().substring(0, 10)%></td>
				<td width=150 align=center bgcolor="ffffff"><%=board.getQb_vcount()%></td>
			</tr>
			<%
			}
			%>
