								...
								<td><br/>
									...
									<div id='f'>
										<table align=center width=80% border=0 cellpadding=0 cellspacing=1 bgcolor="BBBBBB">
											<tr>
												<td width=60 height=25 align="center" bgcolor="E6ECDE" class=t1>전체선택<input type="checkbox" ></td>
											...
											<tr>
												<td width=60 height=26 align=center bgcolor="ffffff" class=t1>
													<input type="checkbox" name="cart_item_no_check" onchange="cart_item_select_count();" value="<%=cartItem.getC_item_no()%>" checked="checked">
													</td>
												<td width=40 height=26 align=center bgcolor="ffffff" class=t1>
													<img src='image/<%=cartItem.getProduct().getP_image()%>' width="34" height="28" />
													</td>
												...
												<td width=112 height=26 align=center bgcolor="ffffff" class=t1>
													<form action="cart_update_action.jsp" method="post" id="cart_update_form_<%=cartItem.getC_item_no()%>">
														...
														<input type="button" value="-" onclick="changeNumber('-','cart_update_form_<%=cartItem.getC_item_no()%>');">
														<input type="text" readonly="readonly" size="2" style="text-align: center; width: 15%" name="cart_qty" value="<%=cartItem.getC_item_qty()%>">
														<input type="button" value="+" onclick="changeNumber('+','cart_update_form_<%=cartItem.getC_item_no()%>');">
														</form>
													</td>
		
												<td width=146 height=26 align=center bgcolor="ffffff" class=t1>
													<%=new DecimalFormat("#,##0").format(cartItem.getProduct().getP_price() * cartItem.getC_item_qty())%></td>
												<td width=50 height=26 align=center bgcolor="ffffff" class=t1>
													...
													<form id="cart_delete_item_form_<%=cartItem.getC_item_no()%>">
														<input type="hidden" name="ci_no" value="<%=cartItem.getC_item_no()%>">
															<a href="javascript:cart_delete_item_action('cart_delete_item_form_<%=cartItem.getC_item_no()%>');">
										...
										<br/>
										<table stype="padding-left:10px" border=0 cellpadding=0 cellspacing=1 width=590>
											<tr>
												<td align=center>&nbsp;&nbsp;
													<a href="product_list.jsp" class=m1>계속 구경하기</a>&nbsp;&nbsp;
													<% if(cartList.size() >= 1){ %>
														<a href="javascript:cart-view_form_select_submit();" class=m1>
